...
namespace WebApplication.Models.CrystalDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Product] ([ProductName], [ProductType], [Price], [Number]) VALUES (@" +
                "ProductName, @ProductType, @Price, @Number)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Product] SET [ProductName] = @ProductName, [ProductType] = @ProductType, " +
                "[Price] = @Price, [Number] = @Number WHERE (([Id] = @Original_Id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CrystalReportConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ProductName, ProductType, Price, Number\r\nFROM     Product";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, ProductName, ProductType, Price, Number\r\nFROM     Product";
        ...
        public virtual int Fill(CrystalDataSet.ProductDataTable dataTable) {
        ...
        public virtual CrystalDataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CrystalDataSet.ProductDataTable dataTable = new CrystalDataSet.ProductDataTable();
        ...
        public virtual int FillBy(CrystalDataSet.ProductDataTable dataTable) {
        ...
        public virtual CrystalDataSet.ProductDataTable GetAllData() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CrystalDataSet.ProductDataTable dataTable = new CrystalDataSet.ProductDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CrystalDataSet.ProductDataTable dataTable) {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<int> ProductType, global::System.Nullable<decimal> Price, global::System.Nullable<int> Number, int Original_Id) {
            if ((ProductName == null)) {
