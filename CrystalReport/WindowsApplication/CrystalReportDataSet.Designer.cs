...
namespace WindowsApplication {
    ...
    public partial class CrystalReportDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(string ProductName, int ProductType, decimal Price, int Number) {
...
namespace WindowsApplication.CrystalReportDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([Id] = @Original_Id) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductType = 1 AND [ProductType] IS NULL) OR ([ProductType] = @Original_ProductType)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([ProductName], [ProductType], [Price], [Number]) VAL" +
                "UES (@ProductName, @ProductType, @Price, @Number);\r\nSELECT Id, ProductName, Prod" +
                "uctType, Price, Number FROM Product WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [ProductName] = @ProductName, [ProductType] = @ProductType, [Price] = @Price, [Number] = @Number WHERE (([Id] = @Original_Id) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductType = 1 AND [ProductType] IS NULL) OR ([ProductType] = @Original_ProductType)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)));
SELECT Id, ProductName, ProductType, Price, Number FROM Product WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsApplication.Properties.Settings.Default.CrystalReportConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ProductName, ProductType, Price, Number FROM dbo.Product";
        ...
        public virtual int Fill(CrystalReportDataSet.ProductDataTable dataTable) {
        ...
        public virtual CrystalReportDataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CrystalReportDataSet.ProductDataTable dataTable = new CrystalReportDataSet.ProductDataTable();
        ...
        public virtual int Get(CrystalReportDataSet.ProductDataTable dataTable) {
        ...
        public virtual CrystalReportDataSet.ProductDataTable GetAll() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            CrystalReportDataSet.ProductDataTable dataTable = new CrystalReportDataSet.ProductDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CrystalReportDataSet.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_ProductName, global::System.Nullable<int> Original_ProductType, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Number) {
            ...
            if ((Original_ProductType.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_ProductType.Value));
            }
            else {
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<int> ProductType, global::System.Nullable<decimal> Price, global::System.Nullable<int> Number) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<int> ProductType, global::System.Nullable<decimal> Price, global::System.Nullable<int> Number, int Original_Id, string Original_ProductName, global::System.Nullable<int> Original_ProductType, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Number, int Id) {
            if ((ProductName == null)) {
            ...
            if ((Original_ProductType.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_ProductType.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<int> ProductType, global::System.Nullable<decimal> Price, global::System.Nullable<int> Number, int Original_Id, string Original_ProductName, global::System.Nullable<int> Original_ProductType, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Number) {
            return this.Update(ProductName, ProductType, Price, Number, Original_Id, Original_ProductName, Original_ProductType, Original_Price, Original_Number, Original_Id);
        }
    }
